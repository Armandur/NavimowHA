...
The live map card (multi-session paths, satellite overlay, mow controls,
photo marker) lives in [`map-card/`](../../map-card/) — see its
[README](../../map-card/README.md) for installation and all options.
